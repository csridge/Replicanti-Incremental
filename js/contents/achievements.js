const ACHS = {
    ...
    descs: {
        ...
        52: "Có ít nhất format(e4200) Nhân bản mà không có Ngân hà Nhân bản hay Hy sinh khi ở trong Thử thách Vô hạn số 1.",
        54: "Reach at least format(ee4) Infinity Replicanti.",
    },
    rewards: {
        21: "Bắt đầu với format(1e5) Nhân bản.",
        22: "Ngân hà Nhân bản mạnh hơn 50%.",
        24: "Ngân hà Nhân bản mạnh hơn 25%.",
        26: "Bắt đầu với format(1e10) Nhân bản.",
        27: "Tăng gấp đôi điểm Vô hạn.",

        32: "Bắt đầu với format(1e50) Nhân bản.",
        34: "Nâng cấp Nhân bản không còn tiêu tốn Nhân bản.",
        37: "Hy sinh Nhân bản không còn tiêu tốn Nhân bản.",
        38: "Sản lượng Nhân bản mạnh hơn dựa trên số lượng Nhân bản với tỷ lệ giảm.",

        43: "Bắt đầu với format(1e100) Nhân bản.",
        47: "Tại sao bạn muốn nhìn thấy chúng lạm phát? nah không có đâu...",
        48: "Mở khóa Tự động mua Máy nén Vô hạn.",

        52: "Ngân hà Nhân bản & Hy sinh Nhân bản mạnh hơn 50%.",
        54: "Sản lượng Nhân bản Vô hạn mạnh hơn 50%.",
    },
    checks: {
